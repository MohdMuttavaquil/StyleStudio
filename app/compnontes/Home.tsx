...
const Homes = () => {
    return (
        <>
           ...
           {/* headinh for projects */}
            <div className='flex flex-col gap-2 text-center my-10'>

                <h1 className='text-3xl font-bold'>The <span className='text-orange-500'>Style </span>Vibe</h1>
            ...
            {/* Small About section for projects */}

            <div className='mx-2 px-6 my-10 flex flex-col gap-2'>
                <p className='text-2xl font-semibold'>Why Style<span className="text-orange-500">Vibe</span></p>
           ...
           {/* Services Section */}
            ...
            {/* About $ Address of projects */}

            <div className='mx-2 px-6 my-10 flex flex-col gap-2'>
                <p className='text-2xl font-semibold'>About Style<span className="text-orange-500">Vibe</span></p>
